...
export class CarbsComponent {
  ...
  extractData(entry) {
    ...
    for(var i=0;i<entry.foodEntries.length;i++) {
      ...
      total += ( foodEntry.servings * foodEntry.food.totalCarbs);
    }
    return total;
  }
...
export default angular.module('hapiBodyLoggerApp.report.carbs', [angularChart])
  .component('carbsReport', {
    template: require('./carbs.html'),
    controller: CarbsComponent,
  })
  .name;
