...
export class FatComponent {
  ...
  extractData(entry) {
    ...
    for(var i=0;i<entry.foodEntries.length;i++) {
      ...
      total += ( foodEntry.servings * foodEntry.food.totalFat);
    }
    return total;
  }
...
export default angular.module('hapiBodyLogger.report.fat', [angularChart])
  .component('fatReport', {
    template: require('./fat.html'),
    controller: FatComponent,
  })
  .name;
